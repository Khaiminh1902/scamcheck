    ...
    <div>
      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <div>
          ...
          <button
            onClick={handleCheck}
            className="border px-5 py-2 rounded mt-3"
          >
      ...
      <footer className="fixed bottom-0 left-0 w-full border-t border-gray-200 bg-white py-4 px-6 text-center text-sm text-gray-500">
